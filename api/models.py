...
class KipoAdminRegBs(models.Model):
    registernumber = models.TextField(db_column='registerNumber', blank=True, null=True)  
    registerationdate = models.TextField(db_column='registerationDate', blank=True, null=True)  
    examinationdate = models.TextField(db_column='examinationDate', blank=True, null=True) 
    existduringdate = models.TextField(db_column='existDuringDate', blank=True, null=True) 
    ...
    applicationnumber = models.TextField(db_column='applicationNumber', blank=True, null=True)  
    applicationdate = models.TextField(db_column='applicationDate', blank=True, null=True)  
    publicationnumber = models.TextField(db_column='publicationNumber', blank=True, null=True) 
    publicationdate = models.TextField(db_column='publicationDate', blank=True, null=True) 
    ...
    originalapplicationnumber = models.TextField(db_column='originalApplicationNumber', blank=True, null=True)  
    originalapplicationdate = models.TextField(db_column='originalApplicationDate', blank=True, null=True) 
    classificationcode = models.TextField(db_column='classificationCode', blank=True, null=True)  
    inventiontitle = models.TextField(db_column='inventionTitle', blank=True, null=True)  
    inventiontitleeng = models.TextField(db_column='inventionTitleEng', blank=True, null=True)  
    claimcount = models.TextField(db_column='claimCount', blank=True, null=True)  
    prioritycountry = models.TextField(db_column='priorityCountry', blank=True, null=True)  
    prioritydate = models.TextField(db_column='priorityDate', blank=True, null=True) 
    prioritycount = models.TextField(db_column='priorityCount', blank=True, null=True)
    #id=models.TextField(db_column='id',blank=True,null=True)
